...
set CLASSPATH=%APP_HOME%\lib\SavedProfessionalsService-1.0-SNAPSHOT-all.jar

@rem Execute SavedProfessionalsService
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SAVED_PROFESSIONALS_SERVICE_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
